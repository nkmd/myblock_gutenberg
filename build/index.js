...
* */
 ...
 // работа с датами
 // Панель "Блок" в сайдбаре и переключатель
 // работа с запросами (см. ниже) ($ npm install @wordpress/data)
...
function Edit(_ref) {
  ...
  const {
    postsPerPage,
    showImage
  } = attributes; // получение атрибутов из 'attributes' (block.json)
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkdynamicblock"] = globalThis["webpackChunkdynamicblock"] || [];
